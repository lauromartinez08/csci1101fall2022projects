...
while game_running_flag:
    ...
    if 0 <= game_characteristics["player"]["position"]["x"] + position_delta and game_characteristics["player"]["position"]["x"] + game_tank_sprite.get_width() <= game_characteristics["cpu"]["position"]["x"]:
